...
class WeatherState(FlipDotState):
    # raw data dictionary
    ICONS_RAW = {
        "SUN": {"data": [1,0,65,4,32,8,3,128,15,224,15,224,31,240,223,246,31,240,15,224,15,224,3,128,32,8,65,4,1,0,0,0], "w": 16, "h": 16},
        "CLOUD": {"data": [3,192,7,224,15,240,127,254,255,255,255,255,255,255,127,254], "w": 16, "h": 8},
        "RAIN": {"data": [0,0,33,8,66,16,132,32], "w": 16, "h": 4},
        "SNOW": {"data": [0,0,0,0,0,16,16,40,40,16,17,0,2,128,1,0], "w": 16, "h": 8},
        "LIGHTNING": {"data": [0,0,3,224,7,192,15,128,3,192,7,0,6,0,8,0], "w": 16, "h": 8}
    }
